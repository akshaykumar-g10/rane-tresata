...
.
├─ data/
│  ├─ phone.csv        # Training values for PHONE
...
├─ predict.py                 # Predicts the column category (as demanded)
...
Before starting the project, ensure your environment is properly configured for data handling, preprocessing, modeling, and evaluation. Follow the steps below to set up your development environment.
...
```bash
conda create -n imbalance-env python=3.10 -y
conda activate imbalance-env
